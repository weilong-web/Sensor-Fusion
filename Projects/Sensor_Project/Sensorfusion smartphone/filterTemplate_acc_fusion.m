function [xhat, meas] = filterTemplate_acc_fusion(calAcc, calGyr, calMag)
...
% Note that it is not necessary to provide inputs (calAcc, calGyr, calMag).
  ...
  R_acc = diag([4.09400483037587e-05,5.81275181106369e-05,7.24938072785159e-05]);
  R_gyr = diag([1.47591454590428e-06,2.58538394200885e-06,4.28392010049764e-07]);
  R_mag = diag([0.103289814319005,0.0870308558236569,0.112181890982324]);
  g0 = [0.0725 0.0097 9.9125]';
